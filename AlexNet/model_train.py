...
def tarin_verify_data_process():
    ...
    train_loder = DataLoader(train_data,batch_size=128,shuffle=True,num_workers=4)
    verify_loder = DataLoader(verify_data,batch_size=128,shuffle=True,num_workers=4)
