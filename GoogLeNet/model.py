...
class Inception(nn.Module):
    def __init__(self, in_channels, c1,c2,c3,c4):
        ...
        self.relu = nn.ReLU()
        self.p1_1 = nn.Conv2d(in_channels, out_channels=c1, kernel_size=1, stride=1, padding=0)
        self.p2_1 = nn.Conv2d(in_channels, out_channels=c2[0], kernel_size=1, stride=1, padding=0)
...
class GoogLeNet(nn.Module):
    def __init__(self,Inception):
        ...
        self.block3 = nn.Sequential(
            Inception(192,64,(92,128),(16,32),32),
